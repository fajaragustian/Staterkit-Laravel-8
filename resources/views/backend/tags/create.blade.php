...
@section('title','Add Tags Management')
@section('content')
<!-- Container Fluid-->
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                    id="name" placeholder="Your Name Tags" required value="{{old('name')}}">
                                @error('name')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="meta_title"
                                    ...
                                    placeholder="Your Name Meta Title" required value="{{old('meta_title')}}">
                                @error('meta_title')
                                <div class=" invalid-feedback mt-2">
                                    <div class="alert alert-danger">{{ $message }}</div>
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="meta_keywords"
                                    ...
                                    placeholder="Your Name Meta Keywords" required value="{{old('meta_keywords')}}">
                                @error('meta_keywords')
                                <div class=" invalid-feedback mt-2">
                                    <div class="alert alert-danger">{{ $message }}</div>
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="meta_desc"
                                    ...
                                    placeholder="Your Name Meta Description" required value="{{old('meta_desc')}}">
                                @error('meta_desc')
                                <div class="invalid-feedback mt-2">
                                    <div class="alert alert-danger">{{ $message }}</div>
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description"
                                    ...
                                    placeholder="Your Description Tags" required>{{old('description')}}</textarea>
                                @error('description')
                                <div class="invalid-feedback mt-2">
                                    <div class="alert alert-danger">{{ $message }}</div>
                                </div>
